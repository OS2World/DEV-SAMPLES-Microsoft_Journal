        ...
        case WM_COMMAND:
            switch( LOUSHORT( mp1 ) )
                ...
                case IDDI_SEARCH_OK:
                    ...
                    if( (usLastIndex = (USHORT) (ULONG) WinSendMsg( hwndList, LM_SEARCHSTRING,
...
#else
                    if( !PrfWriteProfileString( hIniFile, szApp, szKey, szValue ) )
                        ;
#endif
...
#else
                    if( !PrfWriteProfileString( hIniFile, szApp, szKey, szVal ) )
            ...
            switch( LOUSHORT( mp1 ) )
                ...
                case IDDI_DEL_KEY_OK:
                    ...
                    if( !WinWriteProfileString( habIniEdit, szApp, szKey, (PCHAR)NULL ) )
                        ;
#else
                    if( !PrfWriteProfileString( hIniFile, szApp, szKey, (PCHAR)NULL ) )
                        ;
#endif
            ...
            switch( LOUSHORT( mp1 ) )
                ...
                case IDDI_DEL_APP_OK:
                    ...
                    if( !WinWriteProfileString( habIniEdit, szApp, (PCHAR)NULL, (PCHAR)NULL ) )
                        ;
#else
                    if( !PrfWriteProfileString( hIniFile, szApp, (PCHAR)NULL, (PCHAR)NULL ) )
                        ;
#endif
